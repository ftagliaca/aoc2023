...
def compute(s: str) -> str:
    ...
    for order in move_orders:
        to_move = crate_stacks[order.move_from][:order.n_crates]
        to_move.extend(crate_stacks[order.move_to])
        crate_stacks[order.move_to] = to_move
        crate_stacks[order.move_from] = crate_stacks[order.move_from][order.n_crates:]
